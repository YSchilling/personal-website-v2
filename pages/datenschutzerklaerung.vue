<template>
    <main>
        <MySection class="py-32">
            ...
            <p>Yorick Schilling<br>
                Kleine Gasse 20<br>
                61130 Nidderau</p>

            <p>E-Mail: contact@yorickschilling.com</p>
            ...
            <div>Quelle: <a class="underline hover:no-underline" href="https://www.e-recht24.de"
                    target="_blank">https://www.e-recht24.de</a></div>
